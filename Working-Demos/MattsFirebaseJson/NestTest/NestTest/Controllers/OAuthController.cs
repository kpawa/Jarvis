...
namespace FirebaseSharpClientConsole
{
    public class OAuthController : ApiController
    {
        ...
        /// 
        /// <summary>
        /// Called by Nest when user grants access.  This does everthing!!!
        /// </summary>
        ...
        public HttpResponseMessage Get(string state, string code)
        {
            ...
            // Program.SubscribeToNestDeviceDataUpdates(accessToken); // what does this do now?
            // this acttually gets the data from the feed and prints it to console...
            SubscribeToNestDeviceDataUpdates(accessToken);
        ...
        // THIS IS THE NEXT FUNCTION I NEED TO USE
        private static void SubscribeToNestDeviceDataUpdates(string _accessToken)
        {
